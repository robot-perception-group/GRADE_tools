...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--number", dest="number", help="Max number of images in total", default=0, type=int)
    parser.add_argument("-p", "--percentage", dest="percentage", help="Max percentage of images in total", default=0, type=int)
    parser.add_argument("-r", "--random", dest="random", help="Randomize the chosen images", default=False)
